...
echo.
echo READ DISCLAIMER ^-^-^> THIS IS FOR EDUCATIONAL PURPOSES ONLY! DO NOT USE THIS ON SOMEONE ELSES PC WITHOUT THEIR EXPLICIT PERMISSION! WE HOLD NO RESPONSIBILITY FOR PC DAMAGE, LOSS OF DATA AND/OR ANYTHING ELSE EVEN IF THE INSTRUCTIONS ARE WRONG AND/OR THIS BATCH FILE DOES SOMETHING ELSE OTHER THAN WE INTENDED!
